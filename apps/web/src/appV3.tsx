...
const LAUNCH_DAY=Date.UTC(2026,8,8),SCHEDULE_VERSION="schedule-v4",RECENT_DAYS_BLOCKED=14;
...
const PROFILES:Profile[]=[
 {key:"mix",label:"Daily Mix",subtitle:"A little bit of the whole internet.",difficulty:["medium","easy","medium","easy","hard","medium"]},
 {key:"culture",label:"Internet Culture",subtitle:"Memes, creators, games and moments that escaped the screen.",categories:["Culture","Gaming","Social","Video","Entertainment","Community"],difficulty:["medium","easy","easy","medium","hard","medium"]},
 {key:"builders",label:"Builders of the Web",subtitle:"Browsers, platforms, infrastructure and the people who built online life.",categories:["Web","Tech","Search","Cloud","Business","Commerce","Security","Open Source"],difficulty:["medium","medium","easy","hard","medium","hard"]},
 {key:"social",label:"Social Web",subtitle:"From chat rooms to feeds, follows and viral loops.",categories:["Social","Communication","Community","Culture","Video"],difficulty:["easy","medium","easy","medium","hard","medium"]},
 {key:"close",label:"Close Call",subtitle:"The years are tighter today. Tiny gaps matter.",minYear:1994,difficulty:["easy","medium","medium","hard","medium","hard"],close:true},
 {key:"hard",label:"Hard Mode",subtitle:"Fewer obvious landmarks. More internet archaeology.",difficulty:["medium","hard","medium","hard","hard","medium"]},
 {key:"modern",label:"Modern Internet",subtitle:"The mobile, social, streaming and AI era.",minYear:2000,difficulty:["easy","easy","medium","medium","hard","medium"]}
];
